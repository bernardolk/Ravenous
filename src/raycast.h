...
Ray cast_pickray() 
{
	float screenX_normalized = (G_INPUT_INFO.mouse_coords.x - GlobalDisplayConfig::VIEWPORT_WIDTH / 2) /
                              (GlobalDisplayConfig::VIEWPORT_WIDTH / 2);
	float screenY_normalized = -1 * (G_INPUT_INFO.mouse_coords.y - GlobalDisplayConfig::VIEWPORT_HEIGHT / 2) / 
